...
describe('AttachmentService', () => {
  ...
  describe('createFormattedAttachment', () => {
    it('should create attachment with timestamped filename', () => {
      ...
      const attachment = AttachmentService.createFormattedAttachment(content, baseFilename, extension);
  ...
  describe('createSearchResultAttachment', () => {
    ...
    it('should use custom base filename when provided', () => {
      ...
      const attachment = AttachmentService.createSearchResultAttachment(query, content, baseFilename);
